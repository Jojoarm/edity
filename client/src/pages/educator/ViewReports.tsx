...
const ViewReports = () => {
  ...
  const { isDashboardPending, dashboardData } = useDashboardData();
  ...
  if (isDashboardPending) return <Loader />;
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="text-center">
              ...
              <div className="text-sm text-gray-500">Activities per Month</div>
            </div>
          </div>
        </div>
      </div>
